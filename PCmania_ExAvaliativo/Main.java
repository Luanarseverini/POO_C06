...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Clique em 1 para promoção Apple");
            System.out.println("Clique em 2 para promoção Samsung");
            System.out.println("Clique em 3 para promoção Dell");
            System.out.println("Para finalizar sua compra clique em 0");
